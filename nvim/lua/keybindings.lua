...
map('n', '<space>t', ':TroubleToggle<CR>', { noremap=true })
...
map("n", "R", "<cmd>Lspsaga rename<cr>", {silent = true, noremap = true})
...
map("n", "D", "<cmd>Lspsaga preview_definition<cr>", { silent = true, noremap = true })
...
map("n", "<F1>", "<cmd>Lspsaga open_floaterm<cr>", { silent = true, noremap = true })
map("x", "<F1>", "<cmd>Lspsaga close_floaterm<cr>", { silent = true, noremap = true })
