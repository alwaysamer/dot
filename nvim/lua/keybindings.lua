...
vim.api.nvim_set_keymap('n', '<C-o>', ':BufferLineCycleNext<CR>', { noremap=true })
vim.api.nvim_set_keymap('n', '<C-i>', ':BufferLineCyclePrev<CR>', { noremap=true })
...
vim.api.nvim_set_keymap('n', '<C-u>', ':undo', { noremap=true })
vim.api.nvim_set_keymap('n', '<C-z>', ':redo', { noremap=true })
