    ...
    config = function()
        require('legendary').setup({
            keymaps = {
                ...
                { '<leader>q',   ":q<CR>",                                                                                       description = "Close Tab" },
                ...
                { '<leader>tt',  ":Lspsaga term_toggle<CR>",                                                                     description = "Toggle Terminal" },
                { '<leader>vca', ":Lspsaga code_action<CR>",                                                                     description = "LSP Code Action" },
                { '<leader>vsd', ":Lspsaga show_line_diagnostics<CR>",                                                           description = "LSP Show Line Diagnostics" },
